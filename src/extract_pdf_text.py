...
def extract_text_from_pdf_cleaned(pdf_path):
    ...
    try:
        with open("../data/Normas_Vestibular_2025.txt", 'x', encoding='utf-8') as txt_file:  # 'x' para criar o arquivo
            txt_file.write("")  # Inicializa com conteúdo vazio
    except FileExistsError:
        pass  # Arquivo já existe, nada a fazer

    # Salvar o texto extraído no arquivo
    with open("../data/Normas_Vestibular_2025.txt", 'w', encoding='utf-8') as txt_file:
...
if __name__ == "__main__":
    ...
    print("Texto extraído e salvo em 'Normas_Vestibular_2025.txt'")
